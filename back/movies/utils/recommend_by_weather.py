...
def recommend_by_weather(weather_id):
    ...
    if weather_id < 300:
        ...
        recommend_conditions = """
            1. Genres: Action, SF, Thriller, War
        ...
        recommend_conditions = """
            1. Genres: Feel-Good Comedies, Adventure, Drama, Music
        ...
        recommend_conditions = """
            1. Genres: Mistery, Thriller, Crime, Horror
        ...
        messages=[
            {
                "role": "user",
                "content": f"""
                Please recommend 15 movies that matches beyond conditions
                ...
                You only can recommend existing well-known movies.
                """,
            },
        ],
    )
